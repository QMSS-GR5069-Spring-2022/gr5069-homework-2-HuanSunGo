...
```{r}
olympic <- read.csv("data/athletes_and_events.csv")
...
```{r}
# Merge one_region_with_serveral_nocs with gdp, on one_region_with_serveral_nocs$region and gdp$Country
...
plot_unadj<- unadj_top10%>%
  ...
  labs(x="Countries",y="Weighted Medal Counts",title="Un-adjusted")+
  coord_flip()
...
plot_adj_pop<-adj_pop_top10%>%
  ...
  scale_color_viridis(discrete=TRUE,option="D")+
  theme(legend.position = "none")+
  labs(x="Countries",y="Pop-Adjusted Medal Counts",title="Pop-adjusted")+
  coord_flip()
...
plot_adj_gdp <- adj_gdp_top10 %>%
  ...
  scale_color_viridis(discrete=TRUE,option="D")+
  theme(legend.position = "none")+
  labs(x="Countries",y="GDP-Adjusted Medal Counts",title="GDP-adjusted")+
  coord_flip()
